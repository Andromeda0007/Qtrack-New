...
export const ROLE_PERMISSIONS: Record<RoleName, string[]> = {
  WAREHOUSE_HEAD: ['CREATE_USER', 'MANAGE_USERS', 'VIEW_AUDIT_LOGS', 'CREATE_GRN', 'UPDATE_LOCATION', 'ISSUE_STOCK', 'RECEIVE_FG', 'DISPATCH_FG', 'REVISE_GRN', 'REPRINT_LABEL', 'APPROVE_CORRECTION', 'ADJUST_STOCK', 'VIEW_STOCK', 'VIEW_REPORTS', 'REQUEST_GRADE_TRANSFER', 'MANAGE_CHAT', 'SEND_MESSAGE'],
  WAREHOUSE_USER: ['CREATE_GRN', 'UPDATE_LOCATION', 'ISSUE_STOCK', 'RECEIVE_FG', 'DISPATCH_FG', 'VIEW_STOCK'],
