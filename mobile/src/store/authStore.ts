...
export const ROLE_PERMISSIONS: Record<RoleName, string[]> = {
  SUPER_ADMIN: ['CREATE_USER', 'MANAGE_USERS', 'VIEW_AUDIT_LOGS', 'VIEW_STOCK', 'VIEW_REPORTS'],
  WAREHOUSE_USER: ['CREATE_GRN', 'UPDATE_LOCATION', 'ISSUE_STOCK', 'RECEIVE_FG', 'DISPATCH_FG', 'VIEW_STOCK'],
  WAREHOUSE_HEAD: ['CREATE_GRN', 'UPDATE_LOCATION', 'ISSUE_STOCK', 'RECEIVE_FG', 'DISPATCH_FG', 'ADJUST_STOCK', 'VIEW_STOCK', 'VIEW_REPORTS', 'REQUEST_GRADE_TRANSFER'],
