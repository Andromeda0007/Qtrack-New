...
export const ROLE_PERMISSIONS: Record<RoleName, string[]> = {
  ...
  QC_EXECUTIVE: ['GENERATE_AR_NUMBER', 'WITHDRAW_SAMPLE', 'SET_UNDER_TEST', 'VIEW_STOCK', 'INITIATE_RETEST', 'SEND_MESSAGE'],
  QC_HEAD: ['GENERATE_AR_NUMBER', 'WITHDRAW_SAMPLE', 'SET_UNDER_TEST', 'APPROVE_MATERIAL', 'REJECT_MATERIAL', 'SET_RETEST_DATE', 'INITIATE_RETEST', 'APPROVE_GRADE_TRANSFER', 'VIEW_STOCK', 'VIEW_REPORTS', 'SEND_MESSAGE'],
  QA_EXECUTIVE: ['INSPECT_FG', 'APPROVE_FG', 'REJECT_FG', 'VIEW_STOCK', 'SEND_MESSAGE'],
