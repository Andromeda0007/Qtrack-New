    ...
    <SafeAreaView style={styles.safe} edges={['top']}>
      ...
      {loading ? (
        ...
        <ScrollView style={styles.scroll} contentContainerStyle={styles.content}>
          ...
          <View style={styles.card}>
            <View style={styles.qtyRow}>
              <View style={styles.qtyBox}>
                <Text style={styles.qtyNum}>{batch.total_quantity}</Text>
                <Text style={styles.qtyLbl}>Total Received</Text>
              </View>
              <View style={styles.qtyDivider} />
              <View style={styles.qtyBox}>
                <Text style={[styles.qtyNum, { color: Colors.success }]}>{batch.remaining_quantity}</Text>
          ...
          <View style={styles.card}>
            <Row label="Date of Receipt" value={toDisplay(batch.date_of_receipt ?? '')} />
            <Divider />
            <Row label="Mfg. Date" value={toDisplay(batch.manufacture_date ?? '')} />
            <Divider />
            <Row label="Exp. Date" value={toDisplay(batch.expiry_date ?? '')} />
            {batch.retest_date ? (
              <>
                <Divider />
                <Row label="Retest Date" value={toDisplay(String(batch.retest_date))} />
              </>
            ) : null}
          </View>
...
const styles = StyleSheet.create({
  ...
  qtyLbl: { fontSize: FontSize.xs, color: Colors.textMuted, marginTop: 2 },
