...
PERMISSIONS = [
    ...
    "INSPECT_FG", "APPROVE_FG", "REJECT_FG", "RELEASE_FG",
    "CREATE_FG_BATCH", "GENERATE_SHIPPER_LABEL",
    "VIEW_STOCK", "VIEW_REPORTS",
    "CREATE_USER", "MANAGE_USERS", "MANAGE_ITEMS", "VIEW_AUDIT_LOGS",
    "MANAGE_CHAT", "SEND_MESSAGE",
    "ADJUST_STOCK",
    "RETEST_TO_QUARANTINE",
]
...
ROLE_PERMISSION_MAP = {
    "WAREHOUSE_HEAD": [
        ...
        "REQUEST_GRADE_TRANSFER", "MANAGE_CHAT", "RETEST_TO_QUARANTINE",
    ],
    "WAREHOUSE_USER": [
        "CREATE_PRODUCT", "UPDATE_LOCATION", "ISSUE_STOCK", "RECEIVE_FG",
        "DISPATCH_FG", "VIEW_STOCK", "SEND_MESSAGE",
        "REQUEST_GRADE_TRANSFER", "RETEST_TO_QUARANTINE",
    ],
    "QC_EXECUTIVE": [
        "GENERATE_AR_NUMBER", "WITHDRAW_SAMPLE", "SET_UNDER_TEST",
    ...
    "QA_EXECUTIVE": [
        "INSPECT_FG", "RELEASE_FG", "GENERATE_SHIPPER_LABEL", "VIEW_STOCK", "SEND_MESSAGE",
    ],
    "QA_HEAD": [
