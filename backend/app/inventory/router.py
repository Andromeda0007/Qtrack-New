    ...
    return [
        {
            ...
            "date_format": getattr(b, "date_format", "DD-MM-YYYY"),
            "po_number": getattr(b, "po_number", None),
            "po_date": getattr(b, "po_date", None),
            "invoice_number": getattr(b, "invoice_number", None),
            "invoice_date": getattr(b, "invoice_date", None),
            "remarks": getattr(b, "remarks", None),
            "issued_to_production": getattr(b, "issued_to_production", False),
