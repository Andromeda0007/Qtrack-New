...
class FinishedGoodsBatch(Base):
    ...
    fgtn_number: Mapped[str | None] = mapped_column(String(100))
    pack_size_count: Mapped[int | None] = mapped_column(Integer)
    pack_size_unit: Mapped[str | None] = mapped_column(String(50))
